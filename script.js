function playGame (){ //put everything inside the playGame function so that the game only starts when the function is called
    function getComputerChoice () { // Create a function that returns the computer's choice of rock, paper, or scissors

        let computerChoice = Math.random(); // Assign each possible move a numerical value. Use Math.random() for this
    ...
    function getHumanChoice () { // Create a function that returns the player's choice by using a prompt
        ...
        function playRound (humanChoice, computerChoice) { //use the returned string values from the getChoices as parameters to customize the result of each round
        ...
        playRound(humanSelection, computerSelection); console.log("Player:", humanScore,"Computer:", computerScore) //the console.log message displays the current score  
        playRound(getHumanChoice(), getComputerChoice()); console.log("Player:", humanScore,"Computer:", computerScore) //put the getChoice functions as parameters so that you get a new value each time the function is called  
        playRound(getHumanChoice(), getComputerChoice()); console.log("Player:", humanScore,"Computer:", computerScore)   
        playRound(getHumanChoice(), getComputerChoice()); console.log("Player:", humanScore,"Computer:", computerScore)   
        playRound(getHumanChoice(), getComputerChoice()); console.log("Player:", humanScore,"Computer:", computerScore)   
